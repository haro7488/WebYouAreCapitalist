...
// 연구 시스템 상수
export const RESEARCH_BASE_SUCCESS_RATE: number = raw.RESEARCH_BASE_SUCCESS_RATE
export const RESEARCH_LEVEL_PENALTY: number = raw.RESEARCH_LEVEL_PENALTY
export const RESEARCH_PITY_INCREMENT: number = raw.RESEARCH_PITY_INCREMENT
export const RESEARCH_RND_LEVEL_BONUS: number = raw.RESEARCH_RND_LEVEL_BONUS
export const RESEARCH_POINT_COST: number = raw.RESEARCH_POINT_COST
